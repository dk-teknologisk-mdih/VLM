...
if __name__ == "__main__":
    ...
    config = {
        'task': 'stack blocks',
        'stack_order': ['green', 'light blue', 'yellow', 'dark blue', 'red'],  # Optional: specify stacking order
        'objects_to_manipulate': ['green block', 'light blue block', 'yellow block', 'dark blue block', 'red block'],  # Optional: specify objects to stack
    ...
    trajectory_result = plan_stacking_trajectory(API_KEY, BASE_URL, config=config)
